...
import { submitJournalResponse } from '../../../../api'

export const JournalQuestions = (props) => {
  ...
  const _handleSubmit = (values, formikHelpers) => {
    let questionIds = Object.keys(values)
    console.log("_handleSubmit", questionIds)
    ...
    if (params.currentPage == totalPage - 1) {
      console.log('Final Response: ', [...params.response, ...response])
    ...
    if (linkedQuestionId) {
      ...
      props.navigation.dispatch(
        StackActions.push('JournalQuestions', {
